'use strict';
/* build-hook-start *//*00001*/try { require('/Users/poojasharma/.vscode/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').default({tool: 'jest', checkSum: '20f2d4e6cd95541fcfc547VAVKAUsHWQZYV1EMVwRXUAVUAlYD', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/poojasharma/.vscode/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20f2d4e6cd95541fcfc547VAVKAUsHWQZYV1EMVwRXUAVUAlYD', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
