'use strict';
/* build-hook-start *//*00001*/try { require('/Users/poojasharma/.vscode/extensions/wallabyjs.console-ninja-1.0.461/out/buildHook/index.js').default({tool: 'jest', checkSum: '20d6a9d1b3f9c9f0b78f9eVgFPDEoAWAQEWFpaVgQBAFtXX1FX', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/poojasharma/.vscode/extensions/wallabyjs.console-ninja-1.0.461/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20d6a9d1b3f9c9f0b78f9eVgFPDEoAWAQEWFpaVgQBAFtXX1FX', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
