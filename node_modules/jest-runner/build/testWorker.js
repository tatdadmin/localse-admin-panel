'use strict';
/* build-hook-start *//*00001*/try { require('/Users/mac/.vscode/extensions/wallabyjs.console-ninja-1.0.393/out/buildHook/index.js').default({tool: 'jest', checkSum: '20b2e5ab3602501a17bc58UAVLAE9TCVMCBVMFBFFXAQRbBAlb', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/mac/.vscode/extensions/wallabyjs.console-ninja-1.0.393/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20b2e5ab3602501a17bc58UAVLAE9TCVMCBVMFBFFXAQRbBAlb', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
