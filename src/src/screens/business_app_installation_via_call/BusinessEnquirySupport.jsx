...
const BusinessEnquirySupport = () => {
  ...
  const getData = async () => {
    try {
      setLoading(true);
      const res = await GET_BUSINESS_ENQUIRY_SUPPORT_DATA();
      console.log(res);
    //   return false
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // return false
      const res = await UPDATE_BUSINESS_ENQUIRY_SUPPORT_DATA(payload);
      if (res?.status_code === 200) {
        ...
        {data && (
          <div>
            ...
            <div style={{ marginBottom: "1rem" }}>
              ...
              <p style={{ margin: "0.2rem 0", fontSize: "1.2rem" }}>
                <strong>Service Provider Name:</strong> {data.service_provider_name || "N/A"}
              </p>
              ...
              <p style={{ margin: "0.2rem 0", fontSize: "1.2rem" }}>
                <strong>Triggerd From:</strong>{" "}
                {data.triggered_from || "N/A"}
              </p>
...
export default BusinessEnquirySupport;